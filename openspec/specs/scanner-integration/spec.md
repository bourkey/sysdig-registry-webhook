# Scanner Integration Capability

## Purpose

This capability manages the integration with the Sysdig CLI Scanner, handling scanner invocation, credential management, output processing, and result reporting.
